...
const BackgroundColor = ({backgroundContainer, height, width}) => {
  return(
...
const Form = ({ placeholder, type, value, onChange, onSubmit, isEditing }) => {
  return(
...
const ContainerNotes = ({listeNote, handleEdit, handleDelete, handleDeleteAll, numberNote})=>{
  return(
    <>
...
const Notes = ({listeNote, handleEdit, handleDelete}) => {
  return(
    listeNote.map((note)=>(
